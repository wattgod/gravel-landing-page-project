...
RACE_TACTICS_AGENCY = [
    ...
    "Race tactics: Tactical framework, three-act structure",
...
FUELING_GUIDE_VARIATIONS = [
    ...
    "Fueling: Gut training from 40g to 80g carbs/hour — systematic protocols",
    ...
    "Fueling: Race nutrition tested in training — systematic protocols",
    "Fueling: Gut training building tolerance, testing products",
    "Fueling: 60-80g carbs/hour on schedule — systematic protocols",
...
RACE_TACTICS_GUIDE_VARIATIONS = [
    ...
    "Tactics: Tactical framework: Three-act structure, mile-specific strategies",
    "Tactics: Three-act structure: Tactical decision trees, mile markers",
    "Tactics: Mile-specific strategies, mental landmarks, decision trees",
    "Tactics: Three-act structure: Tactical framework, mile-specific strategies",
...
MENTAL_GUIDE_VARIATIONS = [
    ...
    "Mental: Tools for breathing, reframing, suffering management",
...
WOMEN_SPECIFIC_GUIDE_VARIATIONS = [
    ...
    "Women: 'Women aren't small men' — cycle phases affect training capacity, not excuses",
    "Women: 'Women aren't small men' — iron loss from monthly blood loss, ferritin targets",
    "Women: 'Women aren't small men' — more carbs needed than men, hormonal health matters",
    "Women: 'Women aren't small men' — sweat less, core temp rises faster in heat",
    "Women: 'Women aren't small men' — more recovery needed than men at same intensity",
    "Women: 'Women aren't small men' — follicular phase for intensity, luteal for base",
    "Women: 'Women aren't small men' — ferritin >50 ng/mL for performance, not 'normal' 15",
    "Women: 'Women aren't small men' — under-fueling carbs disrupts cycle, tanks performance",
    "Women: 'Women aren't small men' — heat adaptation protocols account for thermoregulation",
    "Women: 'Women aren't small men' — recovery structure different from men's at same fitness",
    "Women: 'Women aren't small men' — cycle tracking, iron monitoring, fueling protocols",
    "Women: 'Women aren't small men' — physiology differences that actually affect training",
    "Women: 'Women aren't small men' — iron supplementation, cycle-aware periodization",
    "Women: 'Women aren't small men' — heat/hydration strategies for different thermoregulation",
    "Women: 'Women aren't small men' — equipment considerations: sports bra, chamois, saddle",
    "Women: 'Women aren't small men' — not patronizing bullshit, real differences that matter",
    "Women: 'Women aren't small men' — trainable, manageable, but ignoring them makes it harder",
    "Women: 'Women aren't small men' — cycle phases, iron needs, fueling differences, recovery",
    "Women: 'Women aren't small men' — monthly iron loss, carb needs, heat tolerance, recovery",
    "Women: 'Women aren't small men' — honest acknowledgment of real differences, not weakness",
]
