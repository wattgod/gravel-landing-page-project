...
GUIDE_TOPICS = {
    "ayahuasca": [
        "**Training Fundamentals (Section 3)** — First principles that work with limited hours, not against them",
        "**Training Zones (Section 5)** — FTP-based targets with RPE guidance—no power meter required",
        "**Workout Execution (Section 6)** — How to nail each session type in under 90 minutes",
        "**Technical Skills (Section 7)** — Cornering, descending, rough terrain—skills that prevent race-ending mechanicals",
    ...
    "finisher": [
        "**Training Fundamentals (Section 3)** — Polarized principles that build both endurance and speed",
        "**Your 12-Week Arc (Section 4)** — How base, build, and peak phases stack together for race day",
        "**Training Zones (Section 5)** — Precise power targets and RPE guidance for structured progression",
        "**Workout Execution (Section 6)** — How to execute intervals, tempo rides, and endurance sessions correctly",
    ...
    "podium": [
        "**Training Fundamentals (Section 3)** — Elite training principles: 80% Zone 2, 20% Zone 4-5",
        "**Your 12-Week Arc (Section 4)** — Periodized progression with threshold blocks and VO2max phases",
        "**Workout Execution (Section 6)** — Recovery metrics that prevent overtraining while maximizing adaptation",
        "**Technical Skills (Section 7)** — Race-winning bike handling—cornering speeds and descending lines that matter",
