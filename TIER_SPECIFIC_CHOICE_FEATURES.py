...
CHOICE_FEATURES = {
    "ayahuasca": [
        ...
        "**Fueling protocols** tested on limited training volume—60-80g carbs/hour without GI distress",
    ...
    "podium": [
        ...
        "**Recovery metrics** that prevent overtraining—when to push, when to back off",
